        ...
        fSelect.prototype = {
            ...
            reload: function() {
                if (this.settings.showSearch) {
                    var search =
                        '<div class="input-group border-bottom mb-15 fs-search">' +
                        '<div class="input-group-prepend">' +
                        '<span class="input-group-text pl-0"><i class="fas fa-search"></i></span> ' +
                        '</div>' +
                        '<input class="form-control border-0 rounded-0" type="search" placeholder="' + this.settings.searchText + '" />' +
                        '</div>';
